...
def plotLogistic(r_min,r_max):
	...
	if r_max == 4.0:
		plt.axvline(x=3.0, linewidth=0.5, label="2-cycle, Pitchfork Bifurcation", c="darkorange")  # 2-cycle = period doubling. first bifurcation (pitchfork)
		plt.axvline(x=3.828427, linewidth=0.5, label="3-cycle, Saddle Bifurcation", c="indianred" )  # 3-cycle, saddle bifurcation
